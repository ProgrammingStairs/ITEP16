...
function Header(){
    return ( <div className={headerStyle.header}>
            <div className={headerStyle.logo_section}>
                <img src={logo3} className={headerStyle.logo} alt=""/>
            </div>
            <div className={headerStyle.heading_section}>
                <h1>Restoria</h1>
            </div>
            <div className={headerStyle.nav}>
                <label for="hum">
                    <img src={menu} className={headerStyle.humber} alt=""/>
                </label>
                <input type="checkbox" className={headerStyle.hum}/>
                <ul>
